...
def first():
    ...
    dct_quiz = {
        ...
        "correct":"Досліджував українську історію та культуру"
    }
    if request.method == "POST":
...
def second():
    ...
    """
    dct_quiz = {
        "name": "Які висновки робить Микола Ільницький щодо ролі міфів у житті міста (про міфи Львову)?",
        ...
        "correct":"Міфи роблять місто унікальним"
    }
    if request.method == "POST":
        if request.form["button"] == dct_quiz["correct"]:
            session["grade"] = session["grade"] + 1
...
def eleventh():
    ...
    """
    dct_quiz = {
        "name": "Який роман Михайла Гончара вважається його найвідомішим?",
        "in1": "Антициклон",
        "in2": "Буревій",
        "in3": "Альпіністи",
        "correct": "Циклон"
